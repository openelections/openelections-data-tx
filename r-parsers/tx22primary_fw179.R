# This program will seek out and parse all files in a fixed-width-179 character format.
# It was created by modifying tx22primary_fw263.R. Following are some of the goals for this parser:
#
