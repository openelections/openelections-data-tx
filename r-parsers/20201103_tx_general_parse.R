...
dir <- "..\\2020-11 November 3 GE Pctxpct\\"
###############################################################################
...
if (!file.exists("20201103_tx_general_defs.csv")){
    setwd("./r-parsers")
}
def <- read_csv("20201103_tx_general_defs.csv")
...
for (f in list){
    ...
    if(!is.na(mm[1,1])){
        ...
        if (gotxx){
            ...
            f_std <- paste0("20201103__tx__general__",tolower(county0),"__precinct.csv")
